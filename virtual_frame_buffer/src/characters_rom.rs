...
pub fn rom(c: char) -> [u8; CHARACTER_HEIGHT] {
    match c {
        ...
        //'▒' => [0xCC, 0x33, 0xCC, 0x33, 0xCC, 0x33, 0xCC, 0x33], delete key
        ...
        '🮠' => [0x18, 0x30, 0x60, 0xC0, 0x80, 0x00, 0x00, 0x00], // diag top left
        '🮡' => [0x18, 0x0C, 0x06, 0x03, 0x01, 0x00, 0x00, 0x00], // diag top right
        '🮣' => [0x00, 0x00, 0x00, 0x01, 0x03, 0x06, 0x0C, 0x18], // diag bottom right
        '🮢' => [0x00, 0x00, 0x00, 0x80, 0xC0, 0x60, 0x30, 0x18], // diag bottom left
        '🮧' => [0x18, 0x3C, 0x66, 0xC3, 0x00, 0x00, 0x00, 0x00], // point up
        '🮥' => [0x18, 0x0C, 0x06, 0x03, 0x03, 0x06, 0x0C, 0x18], // point right
        '🮦' => [0x00, 0x00, 0x00, 0x00, 0xC3, 0x66, 0x3C, 0x18], // point down
        '🮤' => [0x10, 0x30, 0x60, 0xC0, 0xC0, 0x60, 0x30, 0x10], // point left
        '🮨' => [0x18, 0x30, 0x60, 0xC1, 0x83, 0x06, 0x0C, 0x18], // double diag up
        '🮩' => [0x18, 0x0C, 0x06, 0x83, 0xC1, 0x60, 0x30, 0x18], // double diag down
        ...
        '🮎' => [0xAA, 0x55, 0xAA, 0x55, 0x00, 0x00, 0x00, 0x00], // upper half shade
        '🮍' => [0x0A, 0x05, 0x0A, 0x05, 0x0A, 0x05, 0x0A, 0x05], // right half shade
        '🮏' => [0x00, 0x00, 0x00, 0x00, 0xAA, 0x55, 0xAA, 0x55], // bottom half shade
        '🮌' => [0xA0, 0x50, 0xA0, 0x50, 0xA0, 0x50, 0xA0, 0x50], // left half shade
        '🮜' => [0x55, 0xAA, 0x54, 0xA8, 0x50, 0xA0, 0x40, 0x80], // top left half shade
        '🮝' => [0xAA, 0x55, 0x2A, 0x15, 0x0A, 0x05, 0x02, 0x01], // top right half shade
        '🮞' => [0x01, 0x02, 0x05, 0x0A, 0x15, 0x2A, 0x55, 0xAA], // bottom right half shade
        '🮟' => [0x80, 0x40, 0xA0, 0x50, 0xA8, 0x54, 0xAA, 0x55], // bottom left half shade
        ...
        '🯆' => [0x38, 0x38, 0x92, 0x7C, 0x10, 0x28, 0x28, 0x28], // stick figure arms raised
        '🯅' => [0x38, 0x38, 0x10, 0xFE, 0x10, 0x28, 0x44, 0x82], // stick figure
        '🯇' => [0x38, 0x38, 0x12, 0x7C, 0x90, 0x28, 0x24, 0x22], // stick figure going right
        '🯈' => [0x38, 0x38, 0x90, 0x7C, 0x12, 0x28, 0x48, 0x88], // stick figure going left
